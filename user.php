...
<!--                    <h1>Modern Business - A Bootstrap 3 Template</h1>-->
	...
	<?php
	session_start();
		echo "B I E N V E N I D O :      " , $_SESSION['usuario'];
	?>
	<div align="center">
	  <p><a href="Clientes.html">
      <input type = "Button" value="Clientes">
        </a> <a href="Empleados.html"></a> <a href="Productos.html"></a> <a href="Reservaciones.html">
        <input type = "Button" value="Reservaciones">
           </a> <a href="Usuarios.html"></a> <a href="Ventas.html">
