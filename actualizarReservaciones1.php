...
<!--                    <h1>Modern Business - A Bootstrap 3 Template</h1>-->
    ...
    <div class="section">
	<div align="center">
        <form action="actualizarReservaciones.php" method="post">
  <p>Cambiar reservacion con ID
						  : <?php 
$link=mysql_connect("localhost","root",""); 
mysql_select_db("blackmonkey",$link); 
echo"<select name=ncombo1 id=combo1>"; 

$sql="SELECT idR FROM reservaciones"; 
...
?> 
      ...
      <p>ID del cliente 
					 <label>
      <input name="idC" type="text" id="idC" size="3" maxlength="50" />
      </label>	  :
                           
      
      <p>Fecha: 
	    <label>
	    <input name="fechaR" type="text" id="fechaR" size="40" maxlength="40" />
	    </label>
	  </p>
	  <p>Hora:
        <label>
        <input name="horaR" type="text" id="horaR" size="40" maxlength="40" />
        </label>
</p>
	  <p>
	    <label>
